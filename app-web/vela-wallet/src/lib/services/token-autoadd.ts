// Ported from src/services/token-autoadd.ts @ f9bcb278 — RN seams rewritten to the web modules; logic verbatim.
/**
 ...
 */
import { deriveAssetDeltas, type SimLog } from './sim/sim-assets';
import { loadCustomTokens, saveCustomToken } from './records';
import { clearTokenCache, getCachedHeldTokens } from './wallet-api';
import { resolveTokenMetadata } from './token-metadata';
import { knownTokenSymbol } from './tokens';
