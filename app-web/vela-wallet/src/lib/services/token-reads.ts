// Ported from src/services/token-reads.ts @ f9bcb278 — RN seams rewritten to the web modules; logic verbatim.
/**
 ...
 */
export async function readNativeBalance(chainId: number, owner: string): Promise<bigint | null> {
